        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              {user ? (
                <button onClick={() => navigate('/dashboard')} className="bg-blue-700 hover:bg-blue-800 text-white px-5 py-2 rounded-lg font-medium transition-colors shadow-sm">
                  My Dashboard
                </button>
              ) : (
                <>
                  <Link to="/login" className="text-slate-600 hover:text-blue-700 font-medium transition-colors px-3 py-2">
                    Sign In
                  </Link>
                  <Link to="/register" className="bg-blue-700 hover:bg-blue-800 text-white px-5 py-2 rounded-lg font-medium transition-colors shadow-sm">
                    Get Started
                  </Link>
                </>
              )}
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              >
                {user ? 'Go to Dashboard' : 'Experience the MVP'} <ArrowRight className="h-5 w-5" />
              </button>
