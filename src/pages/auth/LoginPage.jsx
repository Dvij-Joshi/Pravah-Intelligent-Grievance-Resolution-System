      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-1.5 text-sm">Sign in to access the Citizen Portal</p>
          </div>
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link to="/register" className="font-semibold text-blue-700 hover:text-blue-800 transition-colors">
              Register here
            </Link>
          </p>
        </motion.div>
